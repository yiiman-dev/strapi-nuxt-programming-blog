...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=00bb3c5d&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[(_vm.pages.length>0 && _vm.pages[0].Slider.length)?_c('SliderBlock',{attrs:{"sliders":_vm.pages[0].Slider}}):_vm._e(),_vm._ssrNode(" "),(_vm.pages.length>0)?_vm._ssrNode("<div>","</div>",_vm._l((_vm.pages[0].Sections),function(sec){return _vm._ssrNode("<div>","</div>",[(sec.__component==='sections.services')?_c('ServicesBlock',{attrs:{"session":sec}}):_vm._e(),_vm._ssrNode(" "),(sec.__component==='sections.testimotional')?_c('TestimotionalBlock',{attrs:{"session":sec}}):_vm._e(),_vm._ssrNode(" "),(sec.__component==='sections.logos')?_c('LogosBlock',{attrs:{"session":sec}}):_vm._e(),_vm._ssrNode(" "),(sec.__component==='sections.projects')?_c('ProjectsBlock',{attrs:{"session":sec}}):_vm._e(),_vm._ssrNode(" "),(sec.__component==='sections.news')?_c('BlogBlock',{attrs:{"session":sec,"articles":_vm.articles}}):_vm._e()],2)}),0):_vm._e(),_vm._ssrNode(" "+((_vm.pages.length===0)?("<aside id=\"mcgill-hero\" class=\"js-fullheight\"><div class=\"flexslider js-fullheight\"><h1 class=\"text-center\" style=\"margin-top: 40%\">Default Home Page Not Configed yet</h1></div></aside>"):"<!---->"))],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=00bb3c5d&
