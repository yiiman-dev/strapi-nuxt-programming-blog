...
class Strapi extends Hookable {
  constructor (ctx) {
    ...
    this.$http.setBaseURL(runtimeConfig.url || 'http://127.0.0.1:1337')
...
export default async function (ctx, inject) {
  [{"name":"articles","type":"collection"},{"name":"categories","type":"collection"},{"name":"project_cateories","type":"collection"},{"name":"companies","type":"collection"},{"name":"projects","type":"collection"},{"name":"services","type":"collection"},{"name":"testimotionals","type":"collection"},{"name":"pages","type":"collection"},{"name":"menus","type":"collection"},{"name":"homepage","type":"single"},{"name":"global","type":"single"},{"name":"project_categories_page","type":"single"},{"name":"blogpage","type":"single"},{"name":"projectpage","type":"single"}].forEach((entity) => {
  let key
  let type = 'collection'
